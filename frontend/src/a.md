## 6. Improve the navigation
Use shorter link names:

```text
STARK/OS   Command   Missions   Coding   Forge   About
```

Change the navigation so:

- StarkOS is on the left.
- Links are placed beside it.
- The current page is highlighted.
- It stays at the top while scrolling.
- It can scroll sideways on mobile.
- Links do not fold into multiple lines.
- All navigation links use the same style.
- Duplicate navigation CSS is removed.
...
<header className="page-header">
  <p className="technical-label">CODING INTELLIGENCE</p>
  <h1>Your week in code</h1>
  <p className="page-description">
    A view of the projects and languages I worked on this week.
  </p>
</header>
```
...
- Use `h2` for sections.
- Use `h3` for cards.
- Do not use an `h1` in every card.
...
Here is how today is looking.

[Focus score] [Energy score] [Coding today]
...
- Adding your name to the greeting.
- Making the three score cards smaller.
- Explaining what the focus score means.
- Showing missions as small rows.
- Putting warnings in one section.
- Removing unnecessary giant cards.
- Adding a “last updated” label.
- Showing a message when no missions exist.

Personal examples:

```text
You completed 3 of your 5 missions.
You are 42 minutes into your four-hour coding goal.
Your focus score comes from completed missions and coding time.
```
